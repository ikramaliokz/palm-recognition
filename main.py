...
# Load the model
recognitionNetwork = loadCNNModel('weights/resnet18_tongji_unfreezed_extractor.pt', device)
...
# compare_folder(mp_hands, hands, folder_path)

def compare_two_images(mp_hands, hands, image_path1, image_path2, similarity_threshold=0.9):
...
image_path1 = 'test_images/00001.tiff'
image_path2 = 'test_images/00501.tiff'
